...
require (
	...
	github.com/pingcap/tidb v1.1.0-beta.0.20230303060110-ad01574a71b3
	github.com/pingcap/tidb-tools v6.6.0+incompatible
	github.com/pingcap/tidb/parser v0.0.0-20230303060110-ad01574a71b3
